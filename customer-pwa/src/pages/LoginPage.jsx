...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col px-6 pt-16 pb-8">
      ...
      <p className="text-xs font-semibold text-gray-400 tracking-widest uppercase mb-1">Login</p>
      <h1 className="text-2xl font-bold text-[#000F14] mb-8">Welcome Back</h1>
      ...
      <button className="w-full border border-gray-200 rounded-xl py-3 text-sm font-medium text-gray-600 flex items-center justify-center gap-2">
      ...
      <p className="text-center text-sm text-gray-500 mt-auto">
        ...
        <Link to="/register" className="text-[#0FD452] font-semibold">Sign Up</Link>
      </p>
    </div>
  );
}
