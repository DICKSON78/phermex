...
export const telemedicine = {
  ...
  history: () => api.get('/telemedicine/history'),
  slotSettings: () => api.get('/telemedicine/slot-settings'),
  updateSlotSettings: (data) => api.put('/telemedicine/slot-settings', data),
  saveNotes: (id, data) => api.put(`/telemedicine/${id}/notes`, data),
