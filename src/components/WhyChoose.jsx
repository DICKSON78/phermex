...
const reasons = [
  {
    title: 'Built for Tanzanian Pharmacies',
    desc: 'Designed specifically for the Tanzanian market with support for local currencies, mobile money payments, and offline-capable workflows.',
  ...
  },
  {
    ...
    desc: 'Join a growing community of pharmacy owners across Tanzania who rely on Phermex to run their businesses every day.',
    ...
    <section className="bg-gray-50 py-20 lg:py-28" id="about">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-14">
          <p className="text-[#0FD452] text-xs font-bold tracking-[2px] uppercase mb-3">WHY CHOOSE PHERMEX</p>
